$(document).ready(function() {
  ...
  function nextPlayer() {
    ...
    document.getElementById("dice-2").style.display = "none";
    if (
      document.querySelector(".player-0-panel").classList.contains("active")
    ) {
      document.querySelector(".player-0-panel").classList.remove("active");
      document.querySelector(".player-1-panel").classList.add("active");
    } else if (
      document.querySelector(".player-1-panel").classList.contains("active")
    ) {
      document.querySelector(".player-0-panel").classList.add("active");
      document.querySelector(".player-1-panel").classList.remove("active");
    }
  ...
  document.querySelector("input", function() {
    changeScore = document.querySelector(".score-user").value;
  });
